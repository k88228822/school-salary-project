...
import com.yufeimen.application.common.Constants;
...
public class XLSUtil {
     ...
     */
    public String[] readExcelTitle(HSSFWorkbook wb) {
     ...
     */
    public ArrayList<List> readExcelContent(HSSFWorkbook wb) {
        ...
        for (int i = Constants.xlsStartLine; i <= rowNum; i++) {
    ...
    public XLSModel getFromStream(InputStream is) {
        ...
        XLSUtil excelReader = new XLSUtil();
